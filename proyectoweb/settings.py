...
if ENV == 'production':
    ...
    # Configuración para funcionar en /galley/
    FORCE_SCRIPT_NAME = '/galley'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'proyectoweb.context_processor.admin_prefix',
            ],
        },
    },
]
